    ...
    <div className="flex flex-row items-center justify-center py-20 h-screen md:h-auto dark:bg-black bg-black relative w-full">
      <div className="max-w-7xl mx-auto w-full relative overflow-hidden h-full md:h-[40rem] px-4">
        ...
        >
          ...
          <p className="text-center text-slate-200 md:text-lg font-normal text-neutral-700 dark:text-neutral-200 max-w-md mt-2 mx-auto">
            Utilizing <Link className="text-rose-400 hover:underline" href="https://www.wtfisqf.com/">quadratic funding</Link> to enable mass fundraising from small contributions
          </p>
        </motion.div>
